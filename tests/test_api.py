...
import zooprocess_multiple_separator.api as api
...
class TestModelMethods(unittest.TestCase):
    ...
    def test_model_metadata_values(self):
        ...
        self.assertEqual(
            ...
            "zooprocess_multiple_separator".lower().replace("-", "_"),
        )
        self.assertEqual(
            self.meta["author"], "Jean-Olivier Irisson,Marine Colin,Emma Amblard,Victor Reutenauer".replace(", ", ",").split(",")
        )
        self.assertEqual(
