...
def run_train(data_dir, out_dir, n_epochs=10, list_hashtags=["plancton"], batch_size=16):
    ...
    list_hashtags = ["background"] + new_list_hashtags
    ...
    df_res=train_model(model_name, model, train_dataset, processor, batch_size=batch_size,
                epochs=n_epochs, out_dir=outdir)
